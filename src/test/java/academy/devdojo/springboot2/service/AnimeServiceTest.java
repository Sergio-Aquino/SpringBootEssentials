...
class AnimeServiceTest {
    ...
    @Test
    @DisplayName("lIstAll returns a list of animes inside the page object when successful")
    ...
    @Test
    @DisplayName("findByIdOrThrowBadRequestException returns a list of animes when successful")
