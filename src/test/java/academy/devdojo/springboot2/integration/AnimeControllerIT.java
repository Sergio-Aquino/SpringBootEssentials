...
public class AnimeControllerIT {
    ...
    @Test
    @DisplayName("lIst returns a list of animes inside the page object when successful")
    ...
    @Test
    @DisplayName("lIstAll returns a list of animes when successful")
    ...
    @Test
    @DisplayName("findById returns a list of animes when successful")
    ...
    @Test
    @DisplayName("findByName returns an empty list of animes when animes are not found")
...
//
    ...
    void replace_UpdatesAnime_WhenSuccessful() {
        ...
        ResponseEntity<Void> animeResponseEntity = testRestTemplate.exchange("/animes", PUT, new HttpEntity<>(savedAnime), Void.class);
