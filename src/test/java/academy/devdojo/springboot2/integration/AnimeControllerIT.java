...
public class AnimeControllerIT {
   ...
   private static final User USER = User.builder()
            .name("Sergio")
            .password("{bcrypt}$2a$10$HPY3UGb8BkS17UfO6FeDHOrnl7mtkk3VzPRqf26qtmBMtYH/dcOI2")
            .username("Sergio-User")
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleUserCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder =  new RestTemplateBuilder()
                    ...
                    .basicAuthentication("Sergio-User", "kratos");
        ...
        public TestRestTemplate testRestTemplateRoleAdminrCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder =  new RestTemplateBuilder()
                    .rootUri("http://localhost:" + port)
                    .basicAuthentication("Sergio-Admin", "kratos");
...
//
    ...
    void replace_UpdatesAnime_WhenSuccessful() {
        ...
        ResponseEntity<Void> animeResponseEntity = testRestTemplateRoleUser.exchange("/animes", PUT, new HttpEntity<>(savedAnime), Void.class);
